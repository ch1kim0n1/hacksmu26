...
export const PROCESSING_STAGES: ProcessingStage[] = [
  ...
  { key: "detecting", label: "Detecting Calls", color: "#00D9FF" },
  { key: "classifying", label: "Classifying", color: "#00D9FF" },
  { key: "analyzing", label: "Analyzing", color: "#00D9FF" },
