...
function Metric({ label, value }: { label: string; value: string | number }) {
  return (
    <div className="rounded-lg border border-ev-sand bg-ev-cream p-4">
...
export default function BatchPage() {
  ...
  return (
    <main className="p-6 lg:p-8 max-w-6xl mx-auto space-y-6">
        ...
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-ev-charcoal">Batch Dashboard</h1>
        ...
        {loading ? (
          ...
          <div className="rounded-lg border border-danger/20 bg-danger/10 p-8 text-danger">
            {error}
          </div>
        ) : summary ? (
          <div className="space-y-8">
            ...
            <section className="overflow-hidden rounded-lg border border-ev-sand bg-ev-cream">
              <div className="border-b border-ev-sand px-5 py-4">
                <h2 className="text-xl font-semibold text-ev-charcoal">Recordings</h2>
              </div>
              <div className="overflow-x-auto">
                <table className="w-full min-w-[760px] text-left text-sm">
                  <thead className="bg-background-elevated text-xs uppercase tracking-wide text-ev-warm-gray">
                    <tr>
                  ...
                  <tbody>
                    {summary.recordings_summary.map((recording) => (
                      <tr key={recording.recording_id} className="border-t border-ev-sand">
              ...
              <section className="rounded-lg border border-ev-sand bg-ev-cream p-5">
                ...
                <div className="grid gap-3 md:grid-cols-2">
                  {summary.shared_patterns.slice(0, 6).map((pattern, index) => (
                    <div key={index} className="rounded-lg bg-background-elevated p-4">
